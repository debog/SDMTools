...
void runSingle()
{
    ...
    SuperDropletsUtils::dRsqdt<ParticleReal> drsqdt{m_vapour_mat->coeffCurv(),
    ...
    SuperDropletsUtils::NewtonSolver< SuperDropletsUtils::dRsqdt<ParticleReal>,
    ...
    SuperDropletsUtils::TI < SuperDropletsUtils::dRsqdt<ParticleReal>,
                             SuperDropletsUtils::NewtonSolver<SuperDropletsUtils::dRsqdt<ParticleReal>,
                                                              ParticleReal>,
